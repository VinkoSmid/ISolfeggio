...
public class SampleAppMenuGroup
{
    ...
    public View addCheckBoxItem(String text, boolean cheecked)
    {
        CheckBox cb = new CheckBox(mActivity);
        cb.setText(text);
        cb.setChecked(cheecked);
        cb.setTextColor(Color.BLACK);

        mLayout.addView(cb, mLayoutParams);
        View divider = inflater.inflate(dividerResource, null);
        mLayout.addView(divider, mLayoutParams);
    ...
    public View addButtonItem(String text, int command)
    {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Intent myIntent = new Intent(mActivity, CreateList.class);
