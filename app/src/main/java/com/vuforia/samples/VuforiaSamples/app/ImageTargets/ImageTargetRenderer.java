...
public class ImageTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
            ...
            String detectedItem = trackable.getName();
            //IME ZAZNANEGA OBJEKTA
            //Article aTmp = dbHandler.getArticleByName(detectedItem);
            //if(aTmp != null && aTmp.getStatus() != 0) //Zaznan objekt še ni obkljukan
            //{
            //    Vibrator v = (Vibrator) mActivity.getBaseContext().getSystemService(Context.VIBRATOR_SERVICE);
